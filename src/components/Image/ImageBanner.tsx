...
export default function ImageBanner({ src, id, className }: ImageProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {isHovered ? (
          <div className={cx('wrapper-banner-ImgCenter-imgBanner-seeMore', 'animate__animated', classNameZoom)}>
            <div>
              <div className="mb-4">
