                            ...
                            dataProfileLeft.map((item:any,index:number) => {
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div className={cx('profile-parent-child-content', 'pt-4 p-4',
                                                idSelected !== '' && item.id != idSelected ? 'profile-parent-child-contentSelected' : ''
                                            )}>
                                                <h1 className={cx('text-sm font-semibold')}>
                                                    {params.id === 'men' ? item.content.men.title : item.content.women.title}
                                                </h1>
                                                <p className={cx('text-xs mt-2 font-medium')}>
                                                    {params.id === 'men' ? item.content.men.description : item.content.women.description}
                                                </p>
                                            </div>
                                        </div>
                                    </ArcherElement>
                        ...
                        <ArcherElement id="root">
                            <div>
                                <div className='flex items-center justify-center mb-4'>
                                    <p 
                                        className={cx('text-xl font-bold hover:cursor-pointer',params.id === 'men' ? "text-red-700" : 'text-gray-500')}
                                    ...
                                    <p className='mx-2'>|</p>
                                    <p 
                                        className={cx('text-xl font-bold hover:cursor-pointer',params.id === 'women' ? "text-red-700" : 'text-gray-500')}
                                ...
                                </div>
                                {
                                    params.id === 'men' ? (
                                        ...
                                        <video className={cx('profile-img')} width={300} height={500} autoPlay muted loop>
                                            <source src='https://utfs.io/f/f7205f3a-3a25-4246-90a5-744f5d6e14a3-srakos.mp4' type="video/mp4" />
                    ...
                    <div className={cx('profile-parent')}>
                        {
                            dataProfileRight.map((item:any,index:number) => {
                                return (
                                    ...
                                    >
                                        <div className={cx('profile-parent-child', 'mr-6  my-2')}
                                            onMouseEnter={() => handleMouseEnter(item.id)}
                                            onMouseLeave={handleMouseLeave}
                                        >
                                            <div className={cx('profile-parent-child-content', 'pt-4 p-4',
