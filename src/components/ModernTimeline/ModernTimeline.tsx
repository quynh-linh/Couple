...
const DataModernTimeline = [
  {
    ...
    imgSrc:
      'https://firebasestorage.googleapis.com/v0/b/couple-85135.appspot.com/o/IMG_4964.JPG?alt=media&token=dcac4dbb-60ae-4888-a7ac-99682bf1bf9e',
    imgAlt: 'First Date',
    position: 'right',
  },
  {
    ...
    imgSrc:
      'https://firebasestorage.googleapis.com/v0/b/couple-85135.appspot.com/o/1d7fc2326c8698e8bf2206d32b5d941d.jpg?alt=media&token=5cefb461-ffc9-402c-a95d-95426445383d',
  ...
  },
  {
    ...
    imgSrc:
      'https://firebasestorage.googleapis.com/v0/b/couple-85135.appspot.com/o/IMG_9574.jpg?alt=media&token=b10d7c1a-c46e-4f6c-a857-ca59b89f1a2e',
  ...
  },
  {
    ...
    imgSrc:
      'https://firebasestorage.googleapis.com/v0/b/couple-85135.appspot.com/o/IMG_0489.jpg?alt=media&token=8d35f5c4-1474-4f35-9971-e32259e24bea',
...
const OppositeContentTimeline: React.FC = () => {
  return (
    <div className={cx('modernTimeLine', 'py-[40px]')}>
